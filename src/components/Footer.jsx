const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-indigo-900 to-purple-900">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-indigo-200 text-base">
              Center for Photonic Communication and Computing - Advancing the frontiers of quantum technology.
            </p>
        ...
        <div className="mt-12 border-t border-indigo-800 pt-8">
          <p className="text-base text-indigo-400 text-center">
            &copy; {new Date().getFullYear()} Robert R. McCormick School of Engineering and Applied Science, Northwestern University. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
